...
def transitive_verb_regression(destination, epochs):
    ...
    k_word_regression(destination, s_o, t, 2, module, word_dim=300, sentence_dim=300, num_epochs=epochs)

if __name__ == "__main__":
    #noun_adjective_pair_regression("models/adj_weights.pt", epochs=25)
    transitive_verb_regression("data/hybrid_weights.pt", epochs=100)