...
def two_word_regression(model_destination, embedding_set, ground_truth, num_epochs = 50, embedding_dim = 300, lr = 0.1):
    """
    ...
    Throws:
        Exception if ground truth data is of different length to 
    """
...
def three_word_regression(model_destination, embedding_set, ground_truth, 
                          num_epochs = 50, word_dim = 100, sentence_dim = 300):
    t = ground_truth # t stores 
    s_o = embedding_set #
